<x-layouts.app :title="__('Postres')">
    ...
    <div class="flex justify-between">
        ...
        <a href="{{ route('dashboard.postres.crear') }}" class="bg-brand-primary  px-5 py-2 rounded text-center mb-10 text-white font-bold" >Agregar postre</a>
        ...
        @forelse ($postres as $postre )
            <div class="bg-white rounded px-2 py-2 w-full flex justify-between">
                ...
                <div class="flex items-center justify-center gap-6">
                    <h2 class="text-slate-900 font-bold text-xl">{{ $postre->nombre }} </h2>
                </div>

                <div class="flex gap-5">

                    <a href="{{ route('dashboard.postres.update', $postre->id) }}" class="flex items-center justify-center w-8 h-8 text-white bg-blue-500 hover:bg-blue-400 rounded-md">
                ...
                <form
                 action="{{ route('dashboard.postres.destroy', $postre->id) }}"
