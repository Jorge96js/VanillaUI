...
">
    ...
    <body class="bg-brand-secondary/15 relative font-primary">
        ...
        <nav id="navbar" class="absolute flex md:flex-row justify-between items-center px-5  w-full top-0 left-0 z-10 h-20 {{ Route::is('home') ? 'bg-transparent' : 'bg-brand-primary' }}">
                ...
                <ul class=" shadow-md md:shadow-none md:flex items-center gap-5 px-10" id="menu">
                    ...
                    <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5 {{ request()->routeIs('home') ? 'active' : '' }}">
                        <a class="text-xl text-white font-bold text-shadow-md/30" href="{{ route('home') }}">Inicio</a>
                    </li>

                    <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                        <a class="text-xl text-white font-bold text-shadow-md/30" href="{{ route('productos') }}">Productos</a>
                    </li>

                    <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5 {{ request()->routeIs('heladerias') ? 'active' : '' }}">
                        <a class="text-xl text-white font-bold text-shadow-md/30" href="{{ route('heladerias') }}">Heladerias</a>
                    </li>

                    <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                        <a class="text-xl text-white font-bold text-shadow-md/30" href="{{ route('home') }}/#franquicia">Franquicia</a>
                    </li>

                    <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                        <a class="text-xl text-white font-bold text-shadow-md/30" href="{{ route('home') }}/#contacto">Contacto</a>
                    </li>
                </ul>
            </nav>
            ...
            <footer class="bg-brand-primary w-full flex flex-col">
                ...
                <ul class="flex flex-col md:flex-row justify-center items-center gap-5 mx-auto">
                        ...
                        <li class="overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                            <a class="text-md text-white font-light" href="{{ route('home') }}">Inicio</a>
                        </li>

                        <li class="overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                            <a class="text-md text-white font-light" href="{{ route('productos') }}">Productos</a>
                        </li>

                        <li class="overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                            <a class="text-md text-white font-light" href="{{ route('heladerias') }}">Heladerias</a>
                        </li>

                        <li class="overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                            <a class="text-md text-white font-light" href="{{ route('home') }}/#franquicia">Franquicia</a>
                        </li>

                        <li class="overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                            <a class="text-md text-white font-light" href="{{ route('home') }}/#contacto">Contacto</a>
                        </li>
                    </ul>
                    ...
                    <ul class="flex gap-3 mx-auto mt-5">
                        <li class="p-1 w-10 h-10 flex items-center justify-center cursor-pointer rounded-full bg-brand-primary">
                            <a href="#">
                                <img class="w-5 invert" src="{{ asset('facebook.svg') }}" alt="facebook">
                            </a>
                        </li>
                        <li class="p-1 w-10 h-10 flex items-center justify-center cursor-pointer rounded-full bg-brand-primary">
                            <a href="#">
                                <img class="w-5 invert" src="{{ asset('instagram.svg') }}" alt="instagram">
                            </a>
                        </li>
                        <li class="p-1 w-10 h-10 flex items-center justify-center cursor-pointer rounded-full bg-brand-primary">
                            <a href="#">
                                <img class="w-5 invert" src="{{ asset('tiktok.svg') }}" alt="tiktok">
                            </a>
                        </li>
                    </ul>
                    <div class="w-full p-1 relative bg-brand-primary text-center">
                        ...
                        <p class="relative text-white mt-5 text-xs md:text-base">
                            © {{ date('Y') }} Heladeria. Todos los derechos reservados.
                        </p>
