...
<main>
    ...
    <section class="p-10 mt-70 hidden sm:block sm:mt-30 md:mt-10 lg:mt-0">
        ...
        <a href="{{ route('heladerias') }}" class="float-right bg-brand-primary hover:bg-[#e76322] uppercase text-white text-center font-bold mx-auto px-5 py-2 rounded-md font-secondary">Ver Todas</a>
    </section>
