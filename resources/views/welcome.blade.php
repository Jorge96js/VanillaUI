...
<header class="h-[50rem] bg-brand-primary">
    <div class="swiper-header h-full">
            ...
            <div class="px-20 md:p-20 h-full bg-cover relative bg-bottom" style="background-image: url('{{ asset('imagenes/header-background-1.jpg') }}')">
...
<main>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 max-h-[70rem] h-[30rem] my-20 shadow-md">
        <div class="bg-cover bg-center md:h-full h-72" style="background-image: url('{{ asset('imagenes/header-background-2.webp') }}')"></div>
    ...
    <section class="p-10 mt-70 hidden sm:block sm:mt-30 md:mt-10 lg:mt-0">
        ...
        <div class="overflow-hidden">
            <div class="swiper swiper-sucursales rounded-xl">
                ...
                @forelse ($heladerias as $heladeria )
                ...
                <div class="flex w-full md:w-xl" data-aos="fade-in" data-aos-delay="50">
                        <div class="w-full md:w-xl">
                            <h3 class="text-white text-4xl font-bold mb-10"> {{ $heladeria->Nombre; }} </h3>
                            <ul class="flex flex-col p-0 w-full md:w-xl ">
                                <li class="shadow-md shadow-b mt-1 bg-brand-secondary font-bold text-neutral-800 odd:text-white odd:bg-brand-primary px-5 py-2">Direccion: {{ $heladeria->Direccion }} </li>
                                <li class="shadow-md shadow-b mt-1 bg-brand-secondary font-bold text-neutral-800 odd:text-white odd:bg-brand-primary px-5 py-2">Telefono: {{ $heladeria->Telefono }} </li>
                                <li class="shadow-md shadow-b mt-1 bg-brand-secondary font-bold text-neutral-800 odd:text-white odd:bg-brand-primary px-5 py-2">Horarios: {{ $heladeria->Horarios }} </li>
                                <li class="shadow-md shadow-b mt-1 bg-brand-secondary font-bold text-neutral-800 odd:text-white odd:bg-brand-primary px-5 py-2">Delivery: {{ $heladeria->Delivery ? 'Disponible' : 'No disponible' }} </li>
                            </ul>
                        </div>
                    </div>
        ...
        <a href="{{ route('heladerias') }}" class="float-right bg-brand-primary hover:bg-brand-primary/ uppercase text-white text-center font-bold mx-auto px-5 py-2 rounded-md font-secondary">Ver Todas</a>
    </section>

    <a href="{{ route('heladerias') }}"
    ...
    <section class="py-10 px-5 mt-15 sm:mt-0" id="franquicia">
        <h2 class="text-center text-3xl md:text-[3.4rem] mb-5 text-slate-800 font-bold">{{ config('landing.titulo') }}</h2>
        <p class="text-center mb-10 text-slate-800 text-xs md:text-xl w-8/12 md:w-8/12 mx-auto">
            {{ config('landing.descripcion') }}
        </p>
        ...
        <div class="flex flex-wrap justify-center gap-20">
            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="font-semibold mt-5 text-center font-secondary">{{ config('landing.card_1') }}</p>
            </div>
            ...
            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl  font-secondary" data-aos="fade-up" data-aos-delay="500">
                ...
                <p class="font-semibold mt-5 text-center font-secondary">{{ config('landing.card_2') }}</p>
            </div>
            ...
            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl" data-aos="fade-up" data-aos-delay="600">
                ...
                <p class="font-semibold mt-5 text-center font-secondary">{{ config('landing.card_3') }}</p>
            </div>
        </div>
        ...
        <div class="mt-20 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-0 md:px-5  font-secondary">
            ...
            <div class="bg-slate-50 p-8 border-l-4 border-brand-primary shadow-sm" data-aos="fade-up">
                    ...
                    <p class="text-slate-700 font-secondary">{{ config('landing.log_desc') }}</p>
            </div>
    ...
    <section class=" p-15 w-auto xl:w-7xl md:mb-30 h-auto bg-brand-secondary/25 flex justify-center gap-5 mx-0 md:mx-8 xl:mx-auto mt-20 md:rounded-3xl md:shadow-2xl overflow-hidden" id="contacto">
        ...
        <div class="hidden xl:block lg:w-md">
            <img class="w-md rotate-12" src="{{ asset('imagenes/pngtree-ice-cream-3d-render.png') }}" alt="">
        </div>
    </section>
</main>
