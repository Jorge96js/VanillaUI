...
<main class="py-20">
    ...
    <section class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-5">
        ...
        <div class="rounded-2xl overflow-hidden shadow-lg">
            ...
            <a href="<?php echo e(asset('storage/heladerias/' . $heladeria->Foto)); ?>" data-lightbox="heladeria">
                <img
                    src="<?php echo e(asset('storage/heladerias/' . $heladeria->Foto)); ?>"
                    alt="<?php echo e($heladeria->Nombre); ?>"
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <p class="text-gray-600 text-lg flex items-center gap-2">
                    <svg width="16px" height="16px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="m 8 0 c -3.3125 0 -6 2.6875 -6 6 c 0.007812 0.710938 0.136719 1.414062 0.386719 2.078125 l -0.015625 -0.003906 c 0.636718 1.988281 3.78125 5.082031 5.625 6.929687 h 0.003906 v -0.003906 c 1.507812 -1.507812 3.878906 -3.925781 5.046875 -5.753906 c 0.261719 -0.414063 0.46875 -0.808594 0.585937 -1.171875 l -0.019531 0.003906 c 0.25 -0.664063 0.382813 -1.367187 0.386719 -2.078125 c 0 -3.3125 -2.683594 -6 -6 -6 z m 0 3.691406 c 1.273438 0 2.308594 1.035156 2.308594 2.308594 s -1.035156 2.308594 -2.308594 2.308594 c -1.273438 -0.003906 -2.304688 -1.035156 -2.304688 -2.308594 c -0.003906 -1.273438 1.03125 -2.304688 2.304688 -2.308594 z m 0 0" fill="#2e3436"></path> </g></svg>
                     <span><?php echo e($heladeria->Direccion); ?></span>
                </p>
                ...
                <p class="text-gray-600 text-lg flex items-center gap-2">
                    ...
                    <span><?php echo e($heladeria->Nombre); ?></span>
                </p>
                ...
                <p class="text-gray-600 text-lg flex items-center gap-2">
                    ...
                    <span><?php echo e($heladeria->Telefono ?? 'Sin teléfono disponible'); ?></span>
                </p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heladeria->horarios ?? false): ?>
            <div class="space-y-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($telefono): ?>
                <a href="https://wa.me/<?php echo e($telefono); ?>?text=<?php echo e($mensaje); ?>"
                   target="_blank"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($otras) && $otras->count() > 0): ?>
    <section class="max-w-6xl mx-auto mt-20 px-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $otras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $local): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('heladerias.show', $local->id)); ?>"
                   class="block rounded-xl shadow-lg overflow-hidden bg-white hover:shadow-2xl transition">

                    <img src="<?php echo e($local->imagen ?? 'https://via.placeholder.com/400x300'); ?>"
                         class="w-full h-40 object-cover">

                    <div class="p-4">
                        <h3 class="text-xl font-bold text-gray-700"><?php echo e($local->nombre); ?></h3>
                        <p class="text-gray-500 text-sm"><?php echo e($local->localidad); ?></p>
                    </div>
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/utvrmfia/sanfrahelados.com.ar/resources/views/heladerias/show.blade.php ENDPATH**/ ?>