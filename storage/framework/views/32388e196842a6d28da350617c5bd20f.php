    <div class="flex flex-col md:flex-row justify-evenly items-center py-10">
        <a href="<?php echo e(route('sabores')); ?>">
            <div class="relative w-xs icebowl cursor-pointer">
                ...
                <img class="mt-20" src="<?php echo e(asset('imagenes/bowl-1.png')); ?>" alt="Helado VanillaUI">
                </div>
            </div>
        ...
        <a href="<?php echo e(route('postres')); ?>">
            <div class="relative w-xs icebowl cursor-pointer">
                ...
                <img class="mt-15" src="<?php echo e(asset('imagenes/bowl-3.png')); ?>" alt="Helado VanillaUI">
                </div>
            </div>
        ...
        <a href="<?php echo e(route('tortas')); ?>">
            <div class="relative w-xs icebowl cursor-pointer">
                ...
                <img class="mt-10" src="<?php echo e(asset('imagenes/bowl-2.png')); ?>" alt="Helado VanillaUI">
                </div>
            </div>
...
<?php /**PATH D:\1-ProyectosWEB\sanfrahelados.com.ar\resources\views/components/productos.blade.php ENDPATH**/ ?>