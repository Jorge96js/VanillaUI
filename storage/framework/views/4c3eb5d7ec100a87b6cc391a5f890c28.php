<?php $__env->startSection('contenido'); ?>
    <main class="p-5 md:p-15">
        <h1 class="text-center text-4xl my-20 font-bold font-primary text-slate-800">Sabores Sanfra</h1>

        <h2 class="text-left">Todos los sabores sanfra</h2>
            ...
            <div class="grid gird-cols-1 md:grid-cols-3 p-5 gap-5">
                ...
                <ul class="max-h-max flex flex-col gap-2" data-categoria="chocolates">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="text-center text-gray-400"> Hubo un problema :/ </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1-ProyectosWEB\sanfrahelados.com.ar\resources\views/products/sabores.blade.php ENDPATH**/ ?>