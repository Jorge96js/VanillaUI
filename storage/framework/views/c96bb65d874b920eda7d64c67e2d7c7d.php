...
<header class="h-[40rem] bg-brand-primary">
    <div class="swiper-header h-full">

            <div class="px-20 md:p-20 h-full bg-cover relative" style="background-image: url('<?php echo e(asset('imagenes/header-background.webp')); ?>')">
                <div class="relative z-3 h-full flex flex-col items-start justify-center ">
                    <h1 class="text-white text-5xl md:text-7xl font-extrabold leading-tight drop-shadow-xl">
                        ...
                        <span class="text-brand-primary">Sanfra</span>
                    </h1>
...
<main >
    ...
    <section class="mt-5 pt-20" id="productos">
        ...
        <p class="text-center text-xs w-xs lx:w-md mx-auto text-gray-400">
            Cada visita a Sanfra es una pausa deliciosa en tu día. Cremoso, suave y lleno de sabor.
        </p>
...
<?php endif; ?>
    ...
    <section class="p-10 mt-70 hidden sm:block sm:mt-30 md:mt-10 lg:mt-0">
        ...
        <p class="text-center mb-10 text-slate-800">Descubrí tu sucursal Sanfra más cercana y disfrutá nuestros helados artesanales con la misma calidad de siempre.</p>
        <div class="overflow-hidden">
            <div class="swiper swiper-sucursales rounded-xl">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $heladerias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heladeria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="slide-sucursal p-10 swiper-slide bg-[#F16623]">
                <div class="flex w-full md:w-xl" data-aos="fade-in" data-aos-delay="50">
                        <div class="w-full md:w-xl">
                            ...
                            <ul class="flex flex-col p-0 w-full md:w-xl ">
                                <li class="shadow-md shadow-b mt-1 bg-[#553321] font-bold text-white odd:bg-[#E56221] px-5 py-2">Direccion: <?php echo e($heladeria->Direccion); ?> </li>
                                <li class="shadow-md shadow-b mt-1 bg-[#553321] font-bold text-white odd:bg-[#E56221] px-5 py-2">Telefono: <?php echo e($heladeria->Telefono); ?> </li>
                                <li class="shadow-md shadow-b mt-1 bg-[#553321] font-bold text-white odd:bg-[#E56221] px-5 py-2">Horarios: <?php echo e($heladeria->Horarios); ?> </li>
                                <li class="shadow-md shadow-b mt-1 bg-[#553321] font-bold text-white odd:bg-[#E56221] px-5 py-2">Delivery: <?php echo e($heladeria->Delivery ? 'Disponible' : 'No disponible'); ?> </li>
                            </ul>
                        </div>
                    </div>
    ...
    <section class="py-10 px-5 mt-15 sm:mt-0" id="franquicia">
        ...
        <div class="mt-20 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-5">
            <div class="bg-orange-50 p-8 rounded-2xl border-l-4 border-orange-500 shadow-sm" data-aos="fade-right">
                <h3 class="text-orange-600 font-bold text-xl mb-3 flex items-center">
            ...
            <div class="bg-slate-50 p-8 rounded-2xl border-l-4 border-slate-800 shadow-sm" data-aos="fade-left">
        ...
        <div class="mt-20 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20">
                ...
                <div class="hidden md:block text-orange-500 font-bold">➔</div>
                <div class="flex flex-col items-center max-w-[200px]">
    ...
    <section class="relative w-aut xl:w-7xl md:mb-30 h-92 bg-brand-primary flex justify-center flex-col gap-5 mx-0 md:mx-8 xl:mx-auto mt-20 md:rounded-3xl md:shadow-2xl overflow-hidden" id="contacto">
        <h2 class="text-3xl md:text-4xl font-bold text-shadow-2xs text-slate-100 text-center">Ponte en contacto</h2>
        <h3 class="text-sm md:text-md w-sm md:w-xl mx-auto text-center text-shadow-2xs text-slate-100">¿Tenés una pregunta sobre nuestros sabores, pedidos o franquicias? Escribinos y te respondemos pronto.</h3>
        <a href="https://wa.me/5492364648812?text=Hola%20👋%2C%20me%20interesa%20mucho%20la%20idea%20de%20sumarme%20a%20su%20franquicia%20🚀.%20%C2%BFPodr%C3%ADan%20contarme%20un%20poco%20m%C3%A1s%20sobre%20los%20requisitos%20y%20condiciones%3F
" class="relative z-2 text-center text-white font-bold mx-auto rounded-2xl bg-green-500 hover:bg-green-400 transition-all px-10 py-5 hover:transition hover:scale-95">Contactar por WhatsApp</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/utvrmfia/sanfrahelados.com.ar/resources/views/welcome.blade.php ENDPATH**/ ?>