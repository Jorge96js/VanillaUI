...
<header class="h-[50rem] bg-brand-primary">
    <div class="swiper-header h-full">
            ...
            <div class="px-20 md:p-20 h-full bg-cover relative bg-bottom" style="background-image: url('<?php echo e(asset('imagenes/header-background-1.jpg')); ?>')">
                <div class="relative z-3 h-full flex flex-col items-start justify-center ">
                    ...
                    <p class="text-white text-xl md:text-2xl mt-6 max-w-2xl drop-shadow font-secondary">
                        Sabores auténticos preparados con ingredientes naturales y recetas tradicionales.
                    </p>

                    <div class="mt-8 hover:scale-110 transition-all">
                        <a
                            href="<?php echo e(route('heladerias')); ?>"
                            class="bg-brand-primary font-secondary text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg transition">
                            Buscar sucursal
                        </a>
                    </div>
...
<?php endif; ?>
    ...
    <section class="py-10 px-5 mt-15 sm:mt-0" id="franquicia">
        ...
        <div class="flex flex-wrap justify-center gap-20">
            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="font-semibold mt-5 text-center font-secondary"><?php echo e(config('landing.card_1')); ?></p>
            </div>

            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl  font-secondary" data-aos="fade-up" data-aos-delay="500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16 text-brand-primary">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
                </svg>
                <p class="font-semibold mt-5 text-center font-secondary"><?php echo e(config('landing.card_2')); ?></p>
            </div>
            ...
            <div class="w-50 h-50 flex items-center flex-col p-5 shadow-xl rounded-xl" data-aos="fade-up" data-aos-delay="600">
                ...
                <p class="font-semibold mt-5 text-center font-secondary"><?php echo e(config('landing.card_3')); ?></p>
            </div>
        </div>
        ...
        <div class="mt-20 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-0 md:px-5  font-secondary">
            <div class="bg-gray-50 p-8 border-l-4 border-brand-primary shadow-sm" data-aos="fade-up">
                ...
                <p class="text-slate-700 font-secondary">
            ...
            <div class="bg-slate-50 p-8 border-l-4 border-brand-primary shadow-sm" data-aos="fade-up">
                    ...
                    <p class="text-slate-700 font-secondary"><?php echo e(config('landing.log_desc')); ?></p>
            </div>

        </div>

        <div class="mt-20 text-center  font-secondary">
    ...
    <!--Contacto-->
    <section class=" p-15 w-auto xl:w-7xl md:mb-30 h-auto bg-brand-secondary/25 flex justify-center gap-5 mx-0 md:mx-8 xl:mx-auto mt-20 md:rounded-3xl md:shadow-2xl overflow-hidden" id="contacto">
        ...
        <div class="flex flex-col justify-start gap-5 w-8/12">
            ...
            <div class="flex flex-col gap-5 items-center">
                ...
                <div class="flex flex-col lg:flex-row w-full justify-between gap-5">
                    <a href="#" class="px-10 w-full py-3 text-center rounded-lg bg-white text-brand-primary font-bold  font-secondary border border-brand-primary/15 flex items-center justify-center gap-3"><?php if (isset($component)) { $__componentOriginal28f0851be950bb6091c4ce47c7ea1699 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal28f0851be950bb6091c4ce47c7ea1699 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.location_svg','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.location_svg'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal28f0851be950bb6091c4ce47c7ea1699)): ?>
<?php $attributes = $__attributesOriginal28f0851be950bb6091c4ce47c7ea1699; ?>
<?php unset($__attributesOriginal28f0851be950bb6091c4ce47c7ea1699); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal28f0851be950bb6091c4ce47c7ea1699)): ?>
<?php $component = $__componentOriginal28f0851be950bb6091c4ce47c7ea1699; ?>
<?php unset($__componentOriginal28f0851be950bb6091c4ce47c7ea1699); ?>
<?php endif; ?> Encuentranos</a>
                    <a href="#" class="px-10 w-full py-3 text-center rounded-lg bg-white text-brand-primary font-bold  font-secondary border border-brand-primary/15 flex items-center justify-center gap-3"><?php if (isset($component)) { $__componentOriginalf0b24681403e5873fa7873142af24cb4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf0b24681403e5873fa7873142af24cb4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.phone_svg','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.phone_svg'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf0b24681403e5873fa7873142af24cb4)): ?>
<?php $attributes = $__attributesOriginalf0b24681403e5873fa7873142af24cb4; ?>
<?php unset($__attributesOriginalf0b24681403e5873fa7873142af24cb4); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf0b24681403e5873fa7873142af24cb4)): ?>
<?php $component = $__componentOriginalf0b24681403e5873fa7873142af24cb4; ?>
<?php unset($__componentOriginalf0b24681403e5873fa7873142af24cb4); ?>
<?php endif; ?> Llamanos</a>
                </div>
            </div>
        </div>

        <div class="hidden xl:block lg:w-md">
            <img class="w-md rotate-12" src="<?php echo e(asset('imagenes/pngtree-ice-cream-3d-render.png')); ?>" alt="">
        </div>
    </section>
</main>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1-ProyectosWEB\VanillaUI\resources\views/welcome.blade.php ENDPATH**/ ?>