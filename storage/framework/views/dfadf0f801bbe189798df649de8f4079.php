...
<body class="bg-[#f6f6f6] relative font-primary">
    ...
    <nav id="navbar" class="absolute flex md:flex-row justify-between items-center px-5  w-full top-0 left-0 z-10 h-[5rem] <?php echo e(Route::is('home') ? 'bg-transparent' : 'bg-brand-primary'); ?>">
...
<?php endif; ?>
                ...
                <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5 <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
                    <a class="text-xl text-white font-light" href="<?php echo e(route('home')); ?>">Inicio</a>
                </li>

                <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                    <a class="text-xl text-white font-light" href="<?php echo e(route('productos')); ?>">Productos</a>
                </li>
                ...
                <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5 <?php echo e(request()->routeIs('heladerias') ? 'active' : ''); ?>">
                    <a class="text-xl text-white font-light" href="<?php echo e(route('heladerias')); ?>">Heladerias</a>
                </li>

                <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                    <a class="text-xl text-white font-light" href="<?php echo e(route('home')); ?>/#franquicia">Franquicia</a>
                </li>

                <li class="nav__item overflow-hidden text-left inline-block relative py-1 md:m-0 my-5">
                    <a class="text-xl text-white font-light" href="<?php echo e(route('home')); ?>/#contacto">Contacto</a>
                </li>
            </ul>
        </nav>
...
<?php /**PATH D:\1-ProyectosWEB\sanfrahelados.com.ar\resources\views/layouts/app.blade.php ENDPATH**/ ?>