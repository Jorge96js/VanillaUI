<?php $__env->startSection('contenido'); ?>
    ...
    <main class="py-20">
        ...
        Nuestros Productos <span class="text-brand-primary">VanillaUI</span>
        </h1>
        <h2 class="text-center text-slate-800">
            Helados Artesanales, Postres Helados y Tortas VanillaUI
        </h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1-ProyectosWEB\sanfrahelados.com.ar\resources\views/products/productos.blade.php ENDPATH**/ ?>