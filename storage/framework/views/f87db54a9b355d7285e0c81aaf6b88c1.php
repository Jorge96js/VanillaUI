<?php $__env->startSection('contenido'); ?>
    <main class="p-5 md:p-15">
        <h1 class="text-center text-4xl my-20 font-bold font-primary text-slate-800">Tortas Heladas Sanfra</h1>

        <h2 class="text-left">Todas las tortas heladas</h2>

            <div class="grid gird-cols-1 md:grid-cols-1 p-5 gap-5">
                ...
                <ul class="max-h-max grid place-items-center gap-6 sm:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-center" data-categoria="tortas">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full py-10">
                            <p class="text-center text-gray-500 text-xl font-semibold"> Hubo un problema o no hay tortas disponibles. :/ </p>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1-ProyectosWEB\sanfrahelados.com.ar\resources\views/products/tortas.blade.php ENDPATH**/ ?>